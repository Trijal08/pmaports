...
#
#   google/s5300/hwcfg.bin          52-byte digest of the resolved HW/RF ids
#   google/s5300/rf_cfg.bin         this unit's RF_CFG image, decompressed
#   google/s5300/replay_region.bin  replay archive packed from the live dds.bin
#
...
FW=/sysroot/lib/firmware/google/s5300
